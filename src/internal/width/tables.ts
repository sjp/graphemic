 ...
 * `vendor/ucd/18.0.0/` — committed alongside the generator, never
...
export const ZERO_WIDTH =
  'tFAySvDzIGnIsBBABBBBBC2BFKKBAuBUQAlDHBFCBBDhBABAea7CK6BIJAYDBIBCBErBC0BBFIqB4B3BABAEHEADGKBdA6' +
  'BAEDIAUBaACB5BAEBEBCCDAeBDALB5BAEEBBEAUBWFBA6BACABDIAFDLBeA9BAMAyBADA3BABCFCBDHBLBdA6BACAGAFBU' +
  'BcB5BBEDIAUBdAoCAHCBA6CACGMHiDACILGpCBbABABA3BNBEBBFKBjBJAmDDBFBBCBZBECQDNACBGAPA/VCydCdBeBeBg' +
  'CBBGIACKJAtBE1DBiBA2DCEBJAGC7GBCA6BABGBABACHGJCAwBgCPDwBABEBAFAoBIMBgBDCBBC4BABBDABC6BHCB4ECBM' +
  'BGEAGADBmG/BrQEaExBEBJgDgB+/CCtEAgDfqRDrDB0udDBJgBBwCBwIADAEAZBFA3EBaRNAmBHZKuBCwBACDCBnBAjCFC' +
  'BCBMAIAvBAzBABCCBFBBAqBBIAuHACAEAw5TAhXPQPvGA5HChQAiHA1EEm0BCBBFDoBCEAlFB9RDhCE9JBeEgBPmCKxBD7' +
  ...
  'VCGBBBB6DFDABBBGBAoCBDABA4CAiIBLB0BEFABAXA1mFQGOomLLDCguCE7BG4gBA/BDxCA4lTBBD8yEtBCWgPB+BCJPCG' +
  'eD0ECWBj9B2BExBIAOAWEBOwqBGBQCGBBBEkDAgFG3LA9BD8PD+HBzHACAHBFA6OGtDG21lYAe/CgEvH';
...
export const WIDE =
  ...
  'GauCC1CCmDFqBB9CB1CJvBBnBI8xcD2B5kBcjUj9K8qI/PwYJWiBBSBD1E/C/DG5/bELGJ6mHkBhB/CyDNxcOyB9wHDBGB' +
  'BBoJJAdCCAOEHrMkgI2CJWtkHAqGA+FACJTAxCCNrBEIHBOF6EgBMIBlCBVMqBEEMQDADmCBAB6FC+BNDBXSAaBNA2C0Cw' +
  'BlCGADCCECDLBHI9GAFLEA7IuBBJB4FwDMDmCBADRBMDLloB9//BC9//B';
...
export const EMOJI_PRESENTATION =
  ...
  'YAUACEBCVBuFgBMIBlCBVMqBEEMQDADmCBAB6FC+BNDBXSAaBNA2C0CwBlCGADCCECDLBHIjHLEA7IuBBJB4FwDMDmCBAD' +
  'RBMDL';
